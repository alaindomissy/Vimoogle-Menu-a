...
#   'production': {
#        #'ENGINE': 'django.db.backends.sqlite3',     # Add 'postgresql_psycopg2', 'postgresql', 'mysql', 'sqlite3' or 'oracle'.
#        #'NAME': '/home/picturep/python/cms/cms.db', # Or path to database file if using sqlite3.
#        'ENGINE':   'django.db.backends.mysql',      # Add 'postgresql_psycopg2', 'postgresql', 'mysql', 'sqlite3' or 'oracle'.
#        'NAME':     'picturep_cms',                  # Or path to database file if using sqlite3.
#        'USER':     'picturep_cms',                  # Not used with sqlite3.
#        'PASSWORD': 'pic78787',                      # Not used with sqlite3.
